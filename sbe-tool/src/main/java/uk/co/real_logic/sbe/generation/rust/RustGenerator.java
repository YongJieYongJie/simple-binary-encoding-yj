...
public class RustGenerator implements CodeGenerator {
    ...
    public void generate() throws IOException {
        ...
        Mustache cargoTomlTemplate = mf.compile("rust.templates/cargo-toml.mustache");
        cargoTomlTemplate.execute(cargoFileWriter, cargoToml).flush();

        List<Enum> enumTypeDefs = generateEnums(ir);
        Mustache enumTemplate = mf.compile("rust.templates/typedefs/enum-type.mustache");
        ...
        Mustache bitSetTemplate = mf.compile("rust.templates/typedefs/bitset-struct.mustache");
        ...
        Mustache libRsTemplate = mf.compile("rust.templates/lib-rs.mustache");
